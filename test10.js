...
const getScore = (track) => {
  ...
  // The problem is "Creep (Acoustic)" combined with "Radiohead" doesn't strictly match "Creep Radiohead" or "Radiohead Creep" in the above exact match.
  // But we want it to be considered a very close match if all query words are present in the title+artist!

  // Check if title starts with the exact query (excluding variants)
